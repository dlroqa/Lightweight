...
use lightweight_bench::record::{BenchmarkRun, MachineFingerprint, ModelFingerprint};
use lightweight_bench::{BenchError, BenchmarkStore, RunPlan, Runner};
...
pub async fn run(
    ...
    let plan = RunPlan {
        ...
        scenarios: lightweight_bench::record::Scenario::ALL.to_vec(),
