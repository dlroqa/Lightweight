...
use lightweight_api::chat::UsageBody;
...
use lightweight_inference::{BackendError, GenerationStream};
...
mod tests {
    ...
    use lightweight_inference::generation::Usage;
        ...
        let events = collect(
            vec![
                ...
                Ok(GenerationEvent::Timings(
                    lightweight_inference::generation::Timings {
                        prompt_n: 36,
                        prompt_ms: 2040.73,
                        predicted_n: 3,
                        predicted_ms: 171.5,
    ...
    async fn an_abandoned_generation_reports_what_it_had_cost_so_far() {
        ...
        fn timings(predicted_n: u32, predicted_ms: f64) -> GenerationEvent {
            GenerationEvent::Timings(lightweight_inference::generation::Timings {
                prompt_n: 10,
                prompt_ms: 1000.0,
                predicted_n,
                predicted_ms,
