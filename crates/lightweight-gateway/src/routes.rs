...
use lightweight_api::completions::{CompletionChunkBuilder, CompletionRequest};
use lightweight_api::error::ErrorEnvelope;
use lightweight_api::models::ModelList;
use lightweight_api::props::PropsBody;
use lightweight_api::stream::ChunkBuilder;
use lightweight_core::Actionable;
use lightweight_inference::BackendError;
use lightweight_inference::generation::{FinishReason, GenerationEvent};
...
async fn aggregate(
    mut events: lightweight_inference::GenerationStream,
...
mod tests {
    ...
    fn every_section_27_failure_becomes_the_right_status_and_body() {
        // The gateway's half of the promise. `lightweight_api` proves the body is
