...
use lightweight_core::{InstanceId, RuntimeParams};
...
impl<'a> Runner<'a> {
    ...
    async fn one_with(
        ...
        let machine_before = lightweight_system_info::cpu_times().ok();
        ...
        let machine_after = lightweight_system_info::cpu_times().ok();
        ...
        Ok(Sample {
            ...
            peak_kind: after
                .as_ref()
                .map_or(lightweight_inference::PeakKind::default(), |usage| {
                    usage.peak_kind
                }),
    ...
    async fn usage(&self) -> Option<lightweight_inference::ResourceSnapshot> {
...
fn ticks_between(
    before: &Option<lightweight_inference::ResourceSnapshot>,
    after: &Option<lightweight_inference::ResourceSnapshot>,
) -> Option<u64> {
