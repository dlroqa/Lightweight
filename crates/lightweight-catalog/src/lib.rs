...
//!
//! Separate from the gateway on purpose. `lightweight-gateway` is the HTTP surface,
//! and importing, listing and removing a model must work with no server
//! running — `lightweight models list` is a question about this machine, not about a
