...
use lightweight_system_info::{MemoryProbe, MemorySnapshot};

use crate::estimate::{Budget, ComputeModel, Confidence, Estimate, Verdict};
use lightweight_core::{GgmlType, RuntimeParams};
...
impl Estimator {
    ...
    ) -> Result<Estimate, lightweight_system_info::MemoryError> {
...
mod tests {
    ...
    use super::*;
    use lightweight_core::{GgmlType, RemedyAction};
